...
then
    ...
    docker build -t admin:$IMAGE_TAG .
    docker tag admin:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-admin-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-admin-api:$IMAGE_TAG
