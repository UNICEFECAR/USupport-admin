export default {
  platform_not_error: "Nie znaleziono platformy",
  ...
  not_authenticated_error:
    "Administrator musi się uwierzytelnić, aby uzyskać dostęp do tego zasobu",
  invalid_refresh_token_error:
    "Token odświeżania jest nieprawidłowy lub został już wykorzystany",
  invalid_reset_password_token_error:
    "Nieprawidłowy lub wygasły token resetowania hasła. Poproś o nowy pod adresem: ",
  account_deactivated_error: "Twoje konto zostało dezaktywowane",
  invalid_admin_otp_error: "Nieprawidłowy OTP",
