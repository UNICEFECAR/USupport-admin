...
export const getCouponsDataForCampaignQuery = async ({
  ...
  return pool.query(
    `
        SELECT transaction_log.consultation_id, transaction_log.created_at, type, consultation.provider_detail_id, consultation.client_detail_id, consultation.time
        FROM transaction_log
